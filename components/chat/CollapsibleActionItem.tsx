// components/chat/CollapsibleActionItem.tsx
"use client"
...
const CollapsibleActionItem: React.FC<CollapsibleActionItemProps> = ({
  ...
  return (
    <div className="mb-3">
      <div 
        className="flex items-center gap-2 py-2 px-2 text-gray-300 cursor-pointer hover:bg-gray-800 rounded-md"
        ...
        <div className="flex items-center justify-center w-6 h-6">
          {icon || (
            isLoading ? (
              ...
              <FiCircle className={`w-4 h-4 ${isActive ? 'text-green-500' : 'text-gray-500'}`} />
            )
          )}
        </div>
      ...
      {isOpen && (
        <div className="pl-8 pr-2 py-2 mt-1">
          {screenshots && screenshots.length > 0 && (
            <div className="border border-gray-700 rounded-md overflow-hidden bg-black">
